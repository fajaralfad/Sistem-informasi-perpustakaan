<div>
                    ...
                    <tr class="hover:bg-gray-700 transition-colors duration-150">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="text-sm font-medium text-white">
                                <a href="{{ route('member.buku.detail', $buku->id) }}" class="text-blue-400 hover:text-blue-300">
                                    {{ $buku->judul }}
                                </a>
                            </div>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="flex items-center">
                                @if($buku->stok > 10)
                                    ...
                                    <span class="text-sm text-green-400 font-medium">{{ $buku->stok }}</span>
                                @elseif($buku->stok > 0)
                                    <div class="flex-shrink-0 w-2 h-2 bg-yellow-400 rounded-full mr-2"></div>
                                    <span class="text-sm text-yellow-400 font-medium">{{ $buku->stok }}</span>
                                @else
                                    <div class="flex-shrink-0 w-2 h-2 bg-red-400 rounded-full mr-2"></div>
                                    <span class="text-sm text-red-400 font-medium">{{ $buku->stok }}</span>
                                @endif
                            </div>
                        </td>
    ...
    <!-- Delete Confirmation Modal - Dark Version -->
    @if($bukuIdToDelete)
    <div class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-75">
        <div class="bg-gray-800 rounded-lg shadow-lg p-6 max-w-md w-full mx-4 border border-gray-700">
            ...
            <p class="text-gray-300 text-center mb-6">
                Yakin ingin menghapus buku <strong class="text-white">{{ $bukuJudulToDelete }}</strong>? 
