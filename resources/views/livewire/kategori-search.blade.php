<div>
    ...
    <div class="bg-white rounded-xl shadow-md p-6 mb-6 border border-gray-100">
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            ...
            <div class="text-sm text-gray-500">
                Total: <span class="font-semibold text-gray-700">{{ $kategoris->count() }}</span> kategori
            </div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-md overflow-hidden border border-gray-100">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4">
                                    ...
                                    <div class="text-sm text-gray-500">ID: {{ $kategori->id }}</div>
                                </div>
                            </div>
                        </td>
                        <td class="px-6 py-4">
        ...
        <div class="text-center py-12">
            ...
            <p class="mt-1 text-sm text-gray-500">Mulai dengan menambahkan kategori buku pertama.</p>
            <div class="mt-6">
