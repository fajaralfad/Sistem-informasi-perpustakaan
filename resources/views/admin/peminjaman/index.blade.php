...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="flex justify-between items-center mb-8">
        <div>
            <h1 class="text-2xl sm:text-3xl font-bold text-white">Manajemen Peminjaman</h1>
            <p class="text-gray-300 mt-1">Kelola peminjaman dan booking buku perpustakaan</p>
        </div>
