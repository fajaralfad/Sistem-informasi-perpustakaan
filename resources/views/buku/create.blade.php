                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                    ...
                    <li aria-current="page">
                        <div class="flex items-center">
                            ...
                            <span class="ml-1 text-sm font-medium text-gray-500 md:ml-2">{{ isset($buku) ? 'Edit' : 'Tambah' }}</span>
                        </div>
                    </li>
                </ol>
            </nav>
        ...
        <form action="{{ isset($buku) ? route('admin.buku.update', $buku->id) : route('admin.buku.store') }}" method="POST" enctype="multipart/form-data" class="p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="text" name="judul" id="judul" value="{{ old('judul', $buku->judul ?? '') }}"
                               class="block w-full border border-gray-300 rounded-lg shadow-sm py-2 px-3 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-150 ease-in-out"
                    ...
                    <div>
                        ...
                        <select name="kategori_id" id="kategori_id" 
                                class="block w-full border border-gray-300 rounded-lg shadow-sm py-2 px-3 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-150 ease-in-out" required>
                    ...
                    <!-- Pengarang -->
                    <div>
                        <label for="pengarang_id" class="block text-sm font-medium text-gray-700 mb-1">Pengarang <span class="text-red-500">*</span></label>
                    ...
                    <div>
                        ...
                        <div class="mt-1 flex items-center">
                            <input type="file" name="cover" id="cover"
                                   class="block w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:text-sm file:font-semibold file:bg-blue-50 file:text-blue-700 hover:file:bg-blue-100 transition duration-150 ease-in-out">
                        </div>
                        @error('cover')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                        @if(isset($buku) && $buku->cover)
                            <div class="mt-2">
                                ...
                                <img src="{{ asset('storage/' . $buku->cover) }}" alt="Cover Buku" class="h-32 border border-gray-200 rounded-lg">
                            </div>
                        @endif
                    </div>
                </div>
                ...
                <div class="space-y-4">
                    ...
                    <!-- Tahun Terbit -->
                    <div>
                        <label for="tahun_terbit" class="block text-sm font-medium text-gray-700 mb-1">Tahun Terbit <span class="text-red-500">*</span></label>
