...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="flex justify-between items-center mb-8">
        <div>
            <h1 class="text-2xl sm:text-3xl font-bold text-white">Manajemen Pengarang</h1>
            <p class="text-gray-300 mt-1">Kelola pengarang buku perpustakaan</p>
        </div>
    ...
    <nav class="flex mb-6" aria-label="Breadcrumb">
        <ol class="inline-flex items-center space-x-1 md:space-x-3">
            <li class="inline-flex items-center">
                <a href="{{ route('admin.dashboard') }}" class="inline-flex items-center text-sm font-medium text-white hover:text-indigo-600">
            ...
            <li>
                <div class="flex items-center">
                    ...
                    <span class="ml-1 text-sm font-medium text-gray-500 md:ml-2">Pengarang</span>
                </div>
            </li>
        </ol>
    </nav>
    ...
    <!-- Livewire Component for Search and Table -->
    <livewire:pengarang-search />
</div>
