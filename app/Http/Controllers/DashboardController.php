...
class DashboardController extends Controller
{
    public function index()
    {
        ...
        try {
            ...
            $kunjunganHariIni = Kunjungan::whereDate('waktu_masuk', today())->count();
            $kunjunganAktif = Kunjungan::whereNull('waktu_keluar')->count();
            $kunjunganBulanIni = Kunjungan::where('waktu_masuk', '>=', now()->startOfMonth())->count();
            ...
            // Kunjungan Terkini
            $kunjunganTerkini = Kunjungan::with('user')
                ->latest()
                ->take(5)
                ->get();
